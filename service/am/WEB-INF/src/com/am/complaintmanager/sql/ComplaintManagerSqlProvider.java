package com.am.complaintmanager.sql;
 ...
 * @version 投诉管理sql
 */
public class ComplaintManagerSqlProvider implements SqlProvider{

	@Override
	public String getSql(ActionContext ac) {
		//获取查询单元
		Row queryRow = FastUnit.getQueryRow(ac, "am_bdp","mall_complaint_manager.query");
