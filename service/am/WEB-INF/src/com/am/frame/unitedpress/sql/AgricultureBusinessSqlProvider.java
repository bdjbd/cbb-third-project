 ...
 * @version 涉农企业管理sqlprovider
 * 
 * 
 * 3、联合社管理，显示所有数据，功能只有总社可用
 * 4、配送人员审核，功能为区县使用，显示当前登陆机构及其下级的所有数据
 */
public class AgricultureBusinessSqlProvider implements SqlProvider{
	...
	public String getSql(ActionContext ac) {
		...
		String sql =  "select ur.*,get_membername_by_id(purchaser) AS purchaser_name from mall_agricultural_org as ur "
...
//		}
		...
		//获取查询单元
		Row queryRow = FastUnit.getQueryRow(ac, "am_bdp","agriculture_business.query");
