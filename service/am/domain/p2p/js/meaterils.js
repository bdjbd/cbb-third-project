...
function setRole(event){
  ...
  var id=th.ae.s.id;
  if(id=='1'){
      window.parent.document.getElement('iframe[id=p2p_materialstype.frame.e2]').src='about:blank';
  }else{
      window.parent.document.getElement('iframe[id=p2p_materialstype.frame.e2]').src='/am_bdp/p2p_materialstype.form.do?m=s&p2p_materialstype.form.id='+id;
  }
}
