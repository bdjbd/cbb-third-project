 ...
 * 违规类类报警批量已读
 * */
public class AlarmrecordViolationaction extends DefaultAction{
	public void doAction(DB db, ActionContext ac) throws Exception {
		Logger log = Logger.getLogger(UpdateMaintenance_Mileage.class);
				...
				String msg="无效的操作!";
				// 获取列表选择列		
		String[] List = ac.getRequestParameters("_s_cdms_alarmrecord_violation.list");

		// 获取主键
		String[] id = ac.getRequestParameters("cdms_alarmrecord_violation.list.id.k");
