...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx381c1e253672a0c3";//微信开发平台应用id
	public static String APP_SECRET = "563e72d87a1cca8a51ae846a331f26fd";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1330704401";//财付通商户号
	public static String PARTNER_KEY = "7374685BD304201EE9FD8286F7E93C2D";//商户号对应的密钥
