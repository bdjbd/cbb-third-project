...
public class P2pRechargeListSqlProvider implements SqlProvider {
	...
	public String getSql(ActionContext ac) {
		...
		sql.append(" where 1=1 AND  verifystatus NOT IN (1,2)  ");
		
		Row query = FastUnit.getQueryRow(ac, "wwd", "p2p_rechargemanage.query");
		if(query!=null){
		...
		if(!Checker.isEmpty(rechargedatetiemT)){
			sql.append(" AND rechargeDateTiem<to_date('"+rechargedatetiemT+" 23:59:59','yyyy-mm-dd  HH24:mi:ss') ");
		}
