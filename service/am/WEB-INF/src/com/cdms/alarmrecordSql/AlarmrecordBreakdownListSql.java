...
public class AlarmrecordBreakdownListSql implements SqlProvider{
	...
	public String getSql(ActionContext ac) {
		...
		sql += "select ss.*, am.name from \r\n" + 
				...
				"where  1=1  and ca.car_id =cvb.id  and ca.operation_status='0'  and ca.alarm_type= '1'  and cvb.orgcode like '"+orgids+"%')  ss\r\n" + 
				"LEFT JOIN am_member am\r\n" + 
				" on ss.driver=am.id ";
		
		// 获取查询的所有条件字段的数据
				Row queryRow = FastUnit.getQueryRow(ac, "cdms", "cdms_alarmrecord_breakdown.query");
