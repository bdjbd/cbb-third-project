...
public class PassMarketplaceEntityListAction extends DefaultAction{
	...
	public void doAction(DB db, ActionContext ac) throws Exception {
		...
		String[] auditfee= ac.getRequestParameters("mall_super_marketplace_entity.list.audit_fee");
		String[] member_id= ac.getRequestParameters("mall_super_marketplace_entity.list.memberid");
		String[] release_status = ac.getRequestParameters("mall_super_marketplace_entity.list.release_status");
