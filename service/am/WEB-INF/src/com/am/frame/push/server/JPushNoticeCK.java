...
public class JPushNoticeCK {

    protected static final Logger LOG = LoggerFactory.getLogger(JPushNoticeCK.class);

    //在极光注册上传应用的 appKey 和 masterSecret  
	private static final String appKey =Var.get("jpush_appKey_ck");
	private static final String masterSecret = Var.get("masterSecret_ck");
