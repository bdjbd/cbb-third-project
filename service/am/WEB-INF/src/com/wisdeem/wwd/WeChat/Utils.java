...
import com.wisdeem.wwd.WeChat.beans.Message.MessageTemplet;
...
public class Utils {
	...
	public static String getAccessToken(String token, String appid,
			String appSecret) throws WeChatInfaceException {
	...
	public static void sendEmailTest(String recvEmail, String title, String msg) {
		try {
			...
			email.setAuthenticator(new DefaultAuthenticator(emailAddr
					.split("@")[0], emailPassword));
...
//	}
	...
	public void testEmail() {
		...
		Utils.sendEmailTest("anglezhang_116@126.com", "找回密码", "这是您在电商服务平台的密码："
				+ "32121321321" + "，请您登录后重新修改密码。");
	}
	...
	public static String getFastUnitFilePath(String table, String columName,
			String id) {
		String result = "";
		// ws\files\P2P_ENTERPRISEBADGE\a4bbf9ab-eef6-441d-9f19-8637b9e6ab89\ep_badgeiconpaths
		String fileSpar = "/";
