 ...
 * @version 联合社管理sqlprovider
 */
public class UnitedListSqlProvider implements SqlProvider{
	...
	public String getSql(ActionContext ac) {
		...
		String sql =  "select ur.*,get_membername_by_id(purchaser) AS purchaser_name from UNITED_PRESS as ur "
