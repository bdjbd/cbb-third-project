 ...
 */
public class ConfirmRechangeAction extends DefaultAction {
	...
	public void doAction(DB db, ActionContext ac) throws Exception {
		...
		String success_call_back = "";
		//成功回调参数
		success_call_back=ac.getRequestParameter("account_rechange_manager.form.account_success_backs");
		...
		String requestUrl="/am_bdp/common_confirm_payment.do?m=e"
				...
				+ "&commodityname="+URLEncoder.encode("充值","utf-8");
