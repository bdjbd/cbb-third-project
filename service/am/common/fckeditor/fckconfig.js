...
FCKConfig.ToolbarSets["CMS"] = [
	['Source','-','Undo','Redo','-','RemoveFormat','-','Bold','Italic','Underline','-','OrderedList','UnorderedList','-','Link','Unlink','-','Image','Flash','Table','Rule','SpecialChar',
	'-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','TextColor','BGColor']
] ;
FCKConfig.ToolbarSets["Unit"] = [
	['Source','-','Undo','Redo','-','RemoveFormat','-','FontSize','Bold','Italic','Underline','-','OrderedList','UnorderedList','-','Link','Unlink','-','Image','Table','Rule','SpecialChar','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','TextColor','BGColor']
] ;
FCKConfig.ToolbarSets["Msg"] = [
	['Undo','Redo','-','Bold','Italic','-','OrderedList','UnorderedList','-','Table','Rule','-','PasteWord','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','TextColor','BGColor']
] ;
FCKConfig.ToolbarSets["Sample"] = [
	['Undo','Redo','-','Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','Image','Flash','Table','Rule','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','TextColor','BGColor']
] ;
