...
public class AlarmrecordViolationListSql implements SqlProvider {
	// private Logger
	// logger=LoggerFactory.getLogger(com.am.frame.order.SubmitOrderWebApi.class);
	@Override
	public String getSql(ActionContext ac) {
		...
		sql += "select ss.*, am.name from \r\n"
				...
				+ "where  1=1  and ca.car_id =cvb.id  and ca.operation_status='0'  and ca.alarm_type= '2'  and cvb.orgcode like '"
				+ orgids + "%')  ss\r\n" + "LEFT JOIN am_member am\r\n" + " on ss.driver=am.id ";

		// 获取查询的所有条件字段的数据
		Row queryRow = FastUnit.getQueryRow(ac, "cdms", "cdms_alarmrecord_violation.query");
