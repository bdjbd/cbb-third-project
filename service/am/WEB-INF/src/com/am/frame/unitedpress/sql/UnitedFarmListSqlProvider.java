 ...
 * @version 农场管理sqlprovider
 */
public class UnitedFarmListSqlProvider implements SqlProvider{
	...
	public String getSql(ActionContext ac) {
		...
		String sql =  "select ur.*,get_membername_by_id(ur.purchaser) AS purchaser_name from HOME_FARM as ur "
...
//		}
		...
		//获取查询单元
		Row queryRow = FastUnit.getQueryRow(ac, "am_bdp","united_farm_manager.query");
