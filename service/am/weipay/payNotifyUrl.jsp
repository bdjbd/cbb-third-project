...
<%@ page import="com.am.app_plugins_common.pay.weipay.WepayNotifyResponse" %>
...
if(resHandler.isTenpaySign()) {
	...
	if(httpClient.call()) {
		...
		if(queryRes.isTenpaySign()&& "0".equals(retcode) && "0".equals(trade_state) && "1".equals(trade_mode)) {
			...
			//WepayNotifyResponse wepayNotifyResponse  = new WepayNotifyResponse();
			//JSONObject notifyObj = new JSONObject();
			//notifyObj.put("out_trade_no",queryRes.getParameter("out_trade_no"));
			//notifyObj.put("trade_state",queryRes.getParameter("trade_state"));
			//notifyObj.put("total_fee",queryRes.getParameter("total_fee"));
			//notifyObj.put("time_end",queryRes.getParameter("time_end"));
			//notifyObj.put("out_trade_no",queryRes.getParameter("out_trade_no"));
			//wepayNotifyResponse.notiyResp(,'1');
