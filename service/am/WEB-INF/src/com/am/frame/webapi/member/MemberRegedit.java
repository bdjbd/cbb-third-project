 ...
 * 会员注册
 * */
public class MemberRegedit implements IWebApiService 
{
	
	final Logger logger = LoggerFactory.getLogger(MemberRegedit.class);
...
//		}
		...
		String regUserSQL = "INSERT INTO am_member "
				...
				+ " orgcode,membername,wxheadimg,is_auth,registrationdate "
				+ "  )"
				+ "  VALUES (?, ?, ?, ?,"
				+ " ?,?,?,?, 'now()' "
				+ " )";
