...
public class PassMarketplaceEntityFormAction extends DefaultAction {
	...
	public void doAction(DB db, ActionContext ac) throws Exception {
		...
		// 通过审核
		String id = ac.getRequestParameter("mall_marketplace_entity.form.id");
		String release_status = ac.getRequestParameter("mall_marketplace_entity.form.release_status");
		String review_remarks = ac.getRequestParameter("mall_marketplace_entity.form.review_remarks");
		String audit_fee = ac.getRequestParameter("mall_marketplace_entity.form.audit_fee");
		String memberid = ac.getRequestParameter("mall_marketplace_entity.form.member_id");
