 ...
 * @param publicid
 */
function loadShopListView(pid,orgid,currentPage,callBack){
	$.post("/weshop/loadShopListView.do",{PID:pid,orgidp:orgid,CURRENTPAGE:currentPage},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
 ...
 * @param callBack  回调函数
 */
function loadShopClass(pid,parendId,orgid,callBack){
	$.post("/weshop/loadShopClass.do",{PID:pid,PARENTID:parendId,orgidp:orgid},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
 ...
 * @param callBack  回调函数
 */
function loadShopListViewByClass(pid,orgid,cid,callBack){
	$.post("/weshop/loadShopListViewByClass.do",{PID:pid,CID:cid,orgidp:orgid},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
...
function loadShopByPrice(pid,orderby,orgid,callBack){
	$.post("/weshop/loadShopByPrice.do",{PID:pid,ORDERBY:orderby,orgidp:orgid},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
...
function loadShopByAmount(pid,orgid,orderby,callBack){
	$.post("/weshop/loadShopByAmount.do",{PID:pid,ORDERBY:orderby,orgidp:orgid},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
...
function getOrgnameByToken(pid,orgid,callBack){
	$.post("/weshop/getOrgnameByToken.do",{PID:pid,orgidp:orgid},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
 ...
 * @param  callBack 回调函数
 */
function getSearchShopList(key,token,orgid,callBack){
	$.post("/weshop/getSearchShopList.do",{KEY:key,TOKEN:token,orgidp:orgid},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
...
function getUserStatus(orgid,openid,callBack){
	$.post("/weshop/getUserStatus.do",{ORGIDP:orgid,OPENID:openid},function(data,textStatus){
		if(textStatus=="success"){
			callBack(eval("("+replaceBDPstr(data)+")"));
		}else{
			showNetWorkException();
