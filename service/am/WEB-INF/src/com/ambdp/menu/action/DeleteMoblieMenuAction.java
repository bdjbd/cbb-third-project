 ...
 * 功能：删除终端菜单管理树节点
 */
public class DeleteMoblieMenuAction implements Action {

	private static final String SQL = "delete  from am_mobliemenu where id = ?";
	...
	public ActionContext execute(ActionContext ac) throws Exception {
		...
		if (!Checker.isEmpty(id)) {
			...
			ajax.addScript("window.parent.location='/am_bdp/am_mobliemenu_frameset.do';");
