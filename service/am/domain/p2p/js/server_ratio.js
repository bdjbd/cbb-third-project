...
function setRole(){
  ...
  var id=th.ae.s.id;
  if(id=='1'){
      window.parent.document.getElement('iframe[id=p2p_server_feeratio.e2]').src='about:blank';
  }else{
      window.parent.document.getElement('iframe[id=p2p_server_feeratio.e2]').src='/wwd/ws_server_feeratio.list.do?m=e&ws_server_feeratio.list.comnid='+th.ae.s.id+"&comdytype=3";
  }
}
