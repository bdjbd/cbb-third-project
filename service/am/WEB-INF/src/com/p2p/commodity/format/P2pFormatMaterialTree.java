...
public class P2pFormatMaterialTree extends TreeFactory {
	...
	public Tree createTree(ActionContext ac, String treeDoamin) throws Exception {
		...
		String sql="SELECT * FROM p2p_materialstype WHERE ( orgid LIKE '"+ orgid + "%' OR id ='1' )AND datastatus!=3  ORDER BY createtime";
