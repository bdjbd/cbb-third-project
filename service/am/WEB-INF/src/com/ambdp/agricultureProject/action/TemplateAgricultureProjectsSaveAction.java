 ...
 *@create 2016年4月19日
 *@version
 *说明：农业项目模版 管理保存Action
 */
public class TemplateAgricultureProjectsSaveAction extends DefaultAction{
	...
	public void doAction(DB db, ActionContext ac) throws Exception {
		...
		// 每股金额
		String moneyValue = ac.getRequestParameter("template_mall_agriculture_projects.form.price");
		...
		ac.setAttribute("am_bdp.template_mall_agriculture_projects.form.id", id);
	}
}
