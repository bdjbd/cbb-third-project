...
function setRole(){
  ...
  if(id=='1'){
      ...
      window.parent.document.getElement('iframe[id=goodsorts.frame.e2]').src='/wwd/ws_commodity.form.do?m=s&parent_id='+th.ae.s.id+"&comdytype="+comdytype;
  }
}
...
function addTerminalMenu(){
	var comdytype=document.getElementsByName("goodsorts.tree.comdytype")[0].value;
     window.parent.document.getElement('iframe[id=goodsorts.frame.e2]').src='/wwd/ws_commodity_edit.do?m=a&parent_id='+th.ae.s.id+"&comdytype="+comdytype;
}
//修改终端信息
