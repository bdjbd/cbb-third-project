...
public class PWBRequest {
	...
	private String transactionName="SEND_CODE_REQ";
	private PWBHeader header;
	private IdentityInfo identityInfo;
	
	private List<Order> orderRequest=new ArrayList<Order>();
	...
	public PWBHeader getHeader() {
		return header;
	}
	public void setHeader(PWBHeader header) {
		this.header = header;
	}
	...
	public void setOrderRequest(List<Order> orderRequest) {
